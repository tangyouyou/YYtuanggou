...
<div id="main">
	<div class='left'>
		...
		<div id="content">
		<link href="__PUBLIC__/Css/order.css" type="text/css" rel="stylesheet" >
		<div class='order-nav'>
		    ...
		    <?php if($order): ?><table>
				...
				<tbody>
				    <?php if(is_array($order)): foreach($order as $key=>$v): ?><tr>
							...
							<td>
							    <?php if($v['status'] == '未付款'): ?><a class='btn' href="<?php echo U(GROUP_NAME .'/Buy/payMent');?>/oid/<?php echo ($v["orderid"]); ?>">付款</a><br/><?php endif; ?>
								<a href="<?php echo U(GROUP_NAME .'/Order/del');?>/oid/<?php echo ($v["orderid"]); ?>">删除订单</a>
							</td>
